		...
		//output = outputMain;
			...
			while (sortedBlockSize < endingSortedBlockSize) {
				...
				for (int arrIndex = startIndex; arrIndex < endIndex; arrIndex += sortedBlockSize * 8) {
					...
					__m512 A1in = _mm512_load_ps(&innerArr[0]); // first 16 integers <-- loading in vectors
					cout << "A1in" << endl;
					__m512 A2in = _mm512_load_ps(&innerArr[0]); // second 16 integers <-- loading in vectors
					cout << "A2in" << endl;

					__m512 A1out; // Become inputs of next call
					__m512 A2out; // Become inputs of next call

					__m512 B1in = _mm512_load_ps(&innerArr[0]);
					cout << "B1in" << endl;
					__m512 B2in = _mm512_load_ps(&innerArr[0]);
					cout << "B2in" << endl;
					__m512 B1out;
					__m512 B2out;

					__m512 C1in = _mm512_load_ps(&innerArr[0]);
					cout << "C1in" << endl;
					__m512 C2in = _mm512_load_ps(&innerArr[0]);
					cout << "C2in" << endl;
					__m512 C1out;
					__m512 C2out;

					__m512 D1in = _mm512_load_ps(&innerArr[0]);
					cout << "D1in" << endl;
					__m512 D2in = _mm512_load_ps(&innerArr[0]);
					cout << "D2in" << endl;
					__m512 D1out;
					__m512 D2out;
