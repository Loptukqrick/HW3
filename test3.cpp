...
int main() {
	...
	//for (int i = 0; i < forLoopSize; i++) {
		...
		int *templ = (int*)aligned_alloc(64, sizeof(int) * 65536);
	...
	cout << "Checking to see where one block of 16384 ends and another begins: " << endl;
	cout << "end of first block, beginning of second block:" << endl;
	for (int i = 0; i < 10; i++) {
		cout << a[16379 + i] << endl;
	}
	cout << "------------------" << endl;
	cout << "end of second block, beginning of third block:" << endl;
	for (int i = 0; i < 10; i++) {
		cout << a[32763 + i] << endl;
	}
	cout << "------------------" << endl;
	cout << "end of third block, beginning of fourth block:" << endl;
	for (int i = 0; i < 10; i++) {
		cout << a[49147 + i] << endl;;
	}
	cout << "------------------" << endl;
	cout << "end of fourth block, beginning of fifth block:" << endl;
	for (int i = 0; i < 10; i++) {
		cout << a[65531 + i] << endl;;
	}
	cout << "------------------" << endl;
	cout << "end of eigth block, beginning of ninth block:" << endl;
	for (int i = 0; i < 10; i++) {
		cout << a[131067 + i] << endl;
	}
	//cout << a[8191] << endl;
	//cout << a[8192] << endl;
	//cout << a[16383] << endl;
