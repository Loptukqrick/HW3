					...
					for (int j = 0; j < (sortedBlockSize / 8) - 1; j++) { 
						...
						if (j == (sortedBlockSize / 8) - 2) {
							...
							if (startA1 == endA1) {
								...
								A2in = _mm512_load_si512(&innerArr[startA2]);
								startA2 += 16;
							}
							else if (startA2 == endA2) {
								// do something else
								A2in = _mm512_load_si512(&innerArr[startA1]);
								startA1 += 16;
							}
							...
							if (startB1 == endB1) {
								...
								// do something else
								B2in = _mm512_load_si512(&innerArr[startB1]);
								startB1 += 16;
							}
							else if (startB1 < startB2) {
								B2in = _mm512_load_ps(&innerArr[startB1]);
								startB1 += 16;
							}
							else {
								B2in = _mm512_load_si512(&innerArr[startB2]);
							...
							if (startC1 == endC1) {
								...
								// do something else
								C2in = _mm512_load_si512(&innerArr[startC1]);
								startC1 += 16;
							}
							...
							if (startD1 == endD1) {
								...
								// do something else
								D2in = _mm512_load_si512(&innerArr[startD1]);
								startD1 += 16;
							}
