					...
					for (int j = 0; j < (sortedBlockSize / 8) - 1; j++) { 
						...
						if (j == (sortedBlockSize / 8) - 2) {
							...
							if (startA1 == endA1) {
								...
								__m512 A2in = _mm512_load_si512(&innerArr[startA2]);
								startA2 += 16;
							}
							else if (startA2 == endA2) {
								// do something else
								__m512 A2in = _mm512_load_si512(&innerArr[startA1]);
								startA1 += 16;
							}
							...
							if (startB1 == endB1) {
								...
								__m512 B2in = _mm512_load_si512(&innerArr[startB2]);
								startB2 += 16;
							}
							else if (startB2 == endB2) {
								// do something else
								__m512 B2in = _mm512_load_si512(&innerArr[startB1]);
								startB1 += 16;
							}
							...
							if (startC1 == endC1) {
								...
								__m512 C2in = _mm512_load_si512(&innerArr[startC2]);
								startC2 += 16;
							}
							else if (startC2 == endC2) {
								// do something else
								__m512 C2in = _mm512_load_si512(&innerArr[startC1]);
								startC1 += 16;
							}
							...
							if (startD1 == endD1) {
								...
								__m512 D2in = _mm512_load_si512(&innerArr[startD2]);
								startD2 += 16;
							}
							else if (startD2 == endD2) {
								// do something else
								__m512 D2in = _mm512_load_si512(&innerArr[startD1]);
								startD1 += 16;
							}
