		...
		//output = outputMain;
			...
			while (sortedBlockSize < endingSortedBlockSize) {
				...
				for (int arrIndex = startIndex; arrIndex < endIndex; arrIndex += sortedBlockSize * 8) {
					...
					__m512 A1in = _mm512_load_ps(&a[startA1]); // first 16 integers <-- loading in vectors
					cout << "A1in" << endl;
					__m512 A2in = _mm512_load_ps(&a[startA2]); // second 16 integers <-- loading in vectors
					cout << "A2in" << endl;

					__m512 A1out; // Become inputs of next call
					__m512 A2out; // Become inputs of next call

					__m512 B1in = _mm512_load_ps(&a[startB1]);
					cout << "B1in" << endl;
					...
					__m512 C1in = _mm512_load_ps(&a[startC1]);
					cout << "C1in" << endl;
					...
					__m512 D1in = _mm512_load_ps(&a[startD1]);
					cout << "D1in" << endl;
